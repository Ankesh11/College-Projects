...
<html>
	...
	<body>
		...
		<div id="side_nav">
			<ul>
				<li><a href="order_foods.php" target="frame"><strong>Order Foods</strong></a></li>
				<li><a href="add_or_remove.php" target="frame"><strong>Add or Remove</strong></a></li>
			</ul>
		</div>
		<div id="details">
			<iframe name="frame" id="frame" style="border-radius:10px;background-color:silver;" width="100%" height="100%" border="0" src="foods_index.php" frameBorder="0"></iframe>
		</div>
</body>
</html>
